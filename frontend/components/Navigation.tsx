...
export default function Navigation() {
  ...
  return (
    <nav className="w-64 bg-gray-900 text-white flex flex-col h-screen fixed left-0 top-0 z-50 relative">
      {/* GitHub Link - Top Right */}
      <a
        href="https://github.com/zhao-kun/vibevoice"
        target="_blank"
        rel="noopener noreferrer"
        className="group absolute top-4 right-4 z-10 p-2 rounded-lg bg-white/10 hover:bg-white/20 transition-all duration-200 hover:scale-110 border border-white/20"
